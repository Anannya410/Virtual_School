...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<!--class list joined-->
		 <%
			...
			while(result.next()) {
	 	%>
			<a href = "ToDoJoinedServlet?class_code=<%=result.getInt("class_code") %>">
	...
	<div id="main">
		...
		<!-- Navigation -->
		<nav class="nbar">
			<a href="to-do-list.jsp" class="nbtn"><b>Created</b></a>
			<a href="#assign-dotab.html" class="nbtn" id="thispage"><b>Joined</b></a>
		</nav><hr>
	
			<!--class list created-->
	 	<%
			PreparedStatement pst = conn.prepareStatement("select* from join_info where email = ?");
		...
		<!--cards-->
		<a href = "ToDoJoinedServlet?class_code=<%=rst.getInt("class_code") %>" class="card">
